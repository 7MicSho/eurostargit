<div class="col-12 text-center titlebanner-seller">
    <h1 class="display-3 txt-title" style="margin: 0;"> Administrar Vendedores</h1>
</div>
                                ...
                                <?php for ($i = 0; $i < count($vendedores); $i++) { ?>
                                    ...
                                    <tr>
                                        <td ><span class="badge bg-label-primary me-1">
                                                <?php echo $vendedores[$i]['id_empleado'] ?>
                                            </span>
                                        </td>
                                        <td><i class="bx bx-user-circle"></i> <strong>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <?php if (isset($vendedores[$i]['telefonos'])) { ?>
                                                ...
                                                <select style="border: 0px; color:slategray; margin-left:12px; cursor: pointer;">
                                                    <?php for ($j = 0; $j < count($telefono); $j++) { ?>
                                                        <?php $telparts = explode("|", $telefono[$j]); ?>
                                                        <option  value="<?php echo "+".$telparts[1]." ".$telparts[2]."-".$telparts[3] ?>">
                                                        <?php echo "+".$telparts[1]." (".$telparts[2].") - ".$telparts[3] ?>
                                                        </option>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    '<?php echo $vendedores[$i]['tipo_empleado'] ?>',
                        ...
                        <form method="post" action="?modulo=prospectos&accion=editarprospecto">
                            ...
                            <div class="row clonarcontact">
                                ...
                                <div class="mb-3 col-md-4 col-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                                        <input type="text" class="form-control" id="temp" placeholder="Segundo apellido"
                                            name="temp" aria-label="Segundo apellido"
                                            aria-describedby="basic-icon-default-fullname2" require />
                                    </div>
                                </div>
                                <div class="mb-3 col-md-4 col-6">
                                ...
                                <div class="mb-3  col-md-9 col-12">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input style="text-transform: lowercase;" type="text" class="form-control" id="correo"
                                ...
                                <div class="mb-2 col-12 col-xl-3">
                                    <label class="form-label" for="basic-icon-default-fullname">SELECCIONA Telefono <strong
                                            class="text-danger"></strong></label>
                                    <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text">
                                            <i class="bx bx-hash text-danger"></i>
...
<script>
    function abrirModal(n,p,s,te,su,no,c,t,d) {
    ...
    document.getElementById("temp").value = (te == '1') ? 'Vendedor':'Mostrador';
    ...
    if ((tels[0].split("|"))[0] == ' ') {
        ...
        for (let index = 1; index < tels.length; index++) {
            const o = document.createElement("option");
