                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="txtrfc" placeholder="RFC" name="rfc"
                                        aria-label="RFC" aria-describedby="basic-icon-default-fullname2" required />
                                </div>
                            </div>
                            <div class="mb-3 col-sm-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="txtcurp" placeholder="CURP" name="curp"
                                        aria-label="CURP" aria-describedby="basic-icon-default-fullname2" required />
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function guardarPM() {
        ...
        if (namecomp == '' || razoncomp == '' || mailcomp == '' || giro == '' || tipo == '' || arraycodigo == '' || arraylada == '' || arraytel == '' || arraytipotel == '' || calle == '' || next == '' || ecalles == ''
            ...
            arraycodigocont == '' || arrayladacont == '' || arraytelcont == '') {
            ...
            let url = 'http://192.168.21.63/eurostar/?modulo=clientes&accion=createpmoral';
