                        ...
                        <tr>
                                ...
                                if ($clientes[$i]['fk_id_empresa'] != '') {
                                    for ($j = 0; $j < count($empresas); $j++) {
                                        if ($clientes[$i]['fk_id_empresa'] == $empresas[$j]['id_empresa']) {
                                            ...
                                            $j = count($empresas);
                                            $tel=explode('|', $empresas[$j]['telefono']);
                                        }
                                    }
                                } else {
                                    echo 'S/E';
                            ...
                            <td data-label="nombre: " class="text-center font-w600" style="font-size:small;">
                                <button type="button" class="btn rounded-pill" onclick="abrirModal(
                                    ...
                                    '<?php echo $clientes[$i]['fk_id_mercado'] ?>',
                                    '<?php echo $clientes[$i]['fk_id_giro_mercado'] ?>',
                                    ...
                                    '<?php echo $clientes[$i]['correo'] ?>',
                                    '<?php isset($clientes[$i]['puesto']) ? $txt = $clientes[$i]['puesto'] : $txt = '';echo $txt; ?>',
                                    '<?php echo $clientes[$i]['codigo_pais'] ?>',
                                    '<?php echo $clientes[$i]['lada'] ?>',
                                    '<?php echo $clientes[$i]['numero_telefono'] ?>',
                                    '<?php echo $clientes[$i]['fk_id_vendedor'] ?>'
...
/*idempresa,telemp, nombreemp, rfcemp, razonsocial, giro, tipo, codpais, lada, numerotel, calle, numero, numeroint,
        entrecalles, cp, colonia, municipio, estado, pais, correo, puesto, codpaiscli, ladacli, numtelcli, idvendedor */
                                    '<?php echo $clientesSinEmp[$i]['id_persona'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['id_cliente'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['id_correo'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['id_telefono'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['id_direccion'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['nombre'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['primer_apellido'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['segundo_apellido'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['curp'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['rfc'] ?>',
                                    '',
                                    '',
                                    '',
                                    '',
                                    '',
                                    '<?php echo $clientesSinEmp[$i]['fk_id_mercado'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['fk_id_giro_mercado'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['codigo_pais'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['lada'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['numero_telefono'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['calle'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['numero'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['numero_int'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['entre_calles'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['codigo_postal'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['colonia'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['municipio'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['estado'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['pais'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['correo'] ?>',
                                    '',
                                    '<?php echo $clientesSinEmp[$i]['codigo_pais'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['lada'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['numero_telefono'] ?>',
                                    '<?php echo $clientesSinEmp[$i]['fk_id_vendedor'] ?>'
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalCenterTitle">Editar Cliente</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="?modulo=clientes&accion=editarcliente">
                            ...
                            <input type="hidden" class="form-control" id="idcli" name="idcli" require />
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <select class="form-control" id="giro" placeholder="Giro" name="giro" onchange="tipos()"
...
<script>
    function abrirModal(idpersona, idcliente, idcorreo, idtelefono, iddireccion, nombre,
        papellido, sapellido, curp, rfc, idempresa,telemp, nombreemp, rfcemp, razonsocial, giro, tipo, codpais, lada, numerotel, calle, numero, numeroint,
        entrecalles, cp, colonia, municipio, estado, pais, correo, puesto, codpaiscli, ladacli, numtelcli, idvendedor) {
        $('#modalCliente').modal('show');
            ...
            document.getElementById('puest').value = '';
        if(idempresa==''){
            ...
            document.getElementById('puest').disabled = true;
        }else{
            var telempresa= telemp.split(" ");
            ...
            document.getElementById('puest').disabled = false;
            document.getElementById('idemp').value = idempresa;
            document.getElementById('nomemp').value = nombreemp;
            document.getElementById('rfcemp').value = rfcemp;
            document.getElementById('razonsoc').value = razonsocial;
            document.getElementById('correoemp').value = correo;
            document.getElementById('cod').value = telempresa[0];
            document.getElementById('lada').value = telempresa[1];
            document.getElementById('tel').value = telempresa[2];
            document.getElementById('puest').value = puesto;
        }
        document.getElementById('idper').value = idpersona;
        document.getElementById('idcli').value = idcliente;
        document.getElementById('idcorr').value = idcorreo;
        document.getElementById('idtel').value = idtelefono;
        document.getElementById('iddir').value = iddireccion;
        document.getElementById('id_vendedor').value = idvendedor;
        document.getElementById('giro').value = giro;
        document.getElementById('tipo').value = tipo;
        document.getElementById('cod').value = codpais;
        document.getElementById('lada').value = lada;
        document.getElementById('tel').value = numerotel;
        document.getElementById('calle').value = calle;
        document.getElementById('num').value = numero;
        document.getElementById('numint').value = numeroint;
        document.getElementById('entcalles').value = entrecalles;
        document.getElementById('cp').value = cp;
        document.getElementById('col').value = colonia;
        /*  */
        const municipiosSelect = document.getElementById('mun');
        while(municipiosSelect.options.length>0){
            municipiosSelect.remove(0);
        }
        ...
        var optionToSelect = document.querySelector('#mun option[value="'+mun.value+'"]');
        optionToSelect.selected = true;
        var optionToSelect = document.querySelector('#est option[value="'+est.value+'"]');
        optionToSelect.selected = true;
        /*  */
        document.getElementById('est').value = estado;
        document.getElementById('pais').value = pais;
        document.getElementById('nom').value = nombre;
        document.getElementById('pape').value = papellido;
        document.getElementById('sape').value = sapellido;
        document.getElementById('correo').value = correo;
        
        document.getElementById('cod2').value = codpaiscli;
        document.getElementById('lada2').value = ladacli;
        document.getElementById('tel2').value = numtelcli;
    }
    function tipos(){
