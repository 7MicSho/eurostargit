        ...
        <div class="row">
                        ...
                        <div class="user-avatar-section">
                            <div class=" d-flex align-items-center flex-column">
                                ...
                                <div class="user-info text-center">
                                    <h4 class="mb-2">
                                        <?php echo $cliente[0]['nombre']; ?>
                                    </h4>
                                    <?php if($cliente[0]['nombre_emp']!='N/A'){
                                        echo
                                        '
                                        <span class="badge bg-label-secondary">'.$cliente[0]['nombre_emp'].'</span>
                                        ';
                                    } ?>
                        ...
                        <div class="info-container">
                            <ul class="list-unstyled">
                                <li class="mb-3">
                                    ...
                                    <span>
                                        <?php echo $cliente[0]['nombre'] . ' ' . $cliente[0]['primer_apellido'] . ' ' . $cliente[0]['segundo_apellido']; ?>
                                    </span>
                                </li>
                                <li class="mb-3">
                                    <span class="fw-bold me-2">Email:</span>
                                    <span>
                                        <?php echo $cliente[0]['correo']; ?>
                                    </span>
                                </li>
                                <li class="mb-3">
                                    <span class="fw-bold me-2">Empresa:</span>
                                    <span>
                                        <?php echo $cliente[0]['nombre_emp']; ?>
                                    </span>
                                </li>
                                <li class="mb-3">
                                    <span class="fw-bold me-2">Teléfono:</span>
                                    <span>
                                        <?php echo '+' . $cliente[0]['codigo_pais'] . ' ' . $cliente[0]['lada'] . $cliente[0]['numero_telefono']; ?>
                                    </span>
                                </li>
                                <li class="mb-3">
                                    <span class="fw-bold me-2">Dirección:</span>
                                    <span>
                                        <?php echo $cliente[0]['calle'] . ' #' . $cliente[0]['numero'] . ' ' . $cliente[0]['numero_int'] . ' Col.' . $cliente[0]['colonia'] . ' ' . $cliente[0]['codigo_postal']; ?>
                                    </span>
                                </li>
                                <li class="mb-3">
                                    <span class="fw-bold me-2">Entre calles:</span>
                                    <span>
                                        <?php echo $cliente[0]['entre_calles']; ?>
                                    </span>
                                </li>
                                <li class="mb-3">
                                    <span class="fw-bold me-2">Ciudad:</span>
                                    <span>
                                        <?php echo $cliente[0]['municipio'] . ', ' . $cliente[0]['estado']; ?>
                                    </span>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <ul class="nav nav-pills flex-column flex-md-row mb-3 justify-content-end">
                    <li class="nav-item">
                        <form method="post" action="?modulo=visitas&accion=agregarVisitaCliente">
                            <input type="hidden" name="id_persona" value="<?php echo $cliente[0]['id_persona'] ?>">
                            <input type="hidden" name="id_prospecto"
                                value="<?php echo $cliente[0]['id_cliente'] ?>">
                            <input type="hidden" name="id_correo" value="<?php echo $cliente[0]['id_correo'] ?>">
                            <input type="hidden" name="id_telefono" value="<?php echo $cliente[0]['id_telefono'] ?>">
                            <input type="hidden" name="id_direccion"
                                value="<?php echo $cliente[0]['id_direccion'] ?>">
                            <input type="hidden" name="id_empresa" value="<?php echo $cliente[0]['id_empresa'] ?>">
                ...
                <!-- Project table VENTAS -->
                <div class="card mb-4" style="padding: 0px 15px;">
                    <h5 class="card-header">Ventas registradas</h5>
                    <div class="table-responsive mb-3">
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            <table id="table" class="table dataTable table-striped table-bordered" style="width:100%">
                                <thead>
