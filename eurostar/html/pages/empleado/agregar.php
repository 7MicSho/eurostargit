<div class="col-12 text-center titlebanner-seller">
    <h1 class="display-3 txt-title" style="margin: 0;"> Agregar emplado</h1>
</div>
        ...
        <div class="nav-align-top mb-4">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="navs-pills-persona-fisica" role="tabpanel">
                    <form method="post" action="?modulo=empleado&accion=empleadoadd" enctype="multipart/form-data">
                        <div class="card-header d-flex justify-content-center align-items-center">
                            <h5 class="text-danger text-uppercase">AGREGAR NUEVO EMPLEADO</h5>
                        </div>
                        <div class="row d-flex mb-2">
                            <div class="col-6 col-md-3 text-center text-danger">Información personal</div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6 col-sm-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" id="txtcodigo" placeholder="Código"
                                        name="codigo" aria-label="Código"
                                        aria-describedby="basic-icon-default-fullname2" value="52" required />
                                </div>
                            </div>
                            <div class="mb-3 col-6 col-sm-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="bx bx-phone-call text-danger"></i></span>
                                    <input maxlength="3" minlength="3" type="number" class="form-control" id="txtlada"
                            ...
                            <div class="mb-3 col-12 col-sm-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="bx bx-phone-call text-danger"></i></span>
                                    <input maxlength="7" minlength="7" type="number" class="form-control" id="txttel"
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="bx bx-envelope text-danger"></i></span>
                                    <input maxlength="13" minlength="13" type="text" class="form-control" id="txtrfc"
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="bx bx-envelope text-danger"></i></span>
                                    <input maxlength="18" type="text" class="form-control" id="txtcurp"
                        ...
                        <div class="row d-flex mb-2 mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-6 col-md-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fulladdress2" class="input-group-text"><i
                                            class="bx bx-hash text-danger"></i></span>
                                    <input type="number" class="form-control" id="txtninterior"
                            ...
                            <div class="row d-flex mb-2">
                                <div class="col-6 col-md-3 text-center text-danger">Información de Empleado</div>
                                <hr class="mt-2 mb-3 col-6 col-md-9">
                            </div>
                            <div class="mb-3 col-6 col-md-4">
                                <label class="form-label" for="basic-icon-default-fullname">Sueldo Mensual <strong
                                        class="text-danger">*</strong></label>
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fulladdress2" class="input-group-text"><i
                                            class="bx bx-money text-danger"></i></span>
                                    <input type="number" class="form-control" id="txtcp" placeholder="$" name="sueldo"
                                        aria-label="Numero exterior" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="mb-3 col-6 col-md-4">
                                <label class="form-label" for="basic-icon-default-fullname">Cta Nomina <strong
                                        class="text-danger">*</strong></label>
                                <div class="input-group input-group-merge">
                                    <span id="" class="input-group-text"><i class="bx bx-hash text-danger"></i></span>
                                    <input maxlength="10" type="text" class="form-control" id="txtcolonia"
                                        placeholder="CTA NOMINA" name="cuenta_nomina" aria-label="Numero exterior"
                                        aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="mb-3 col-6 col-md-4">
                                <label for="exampleFormControlSelect1" class="form-label">Tipo empleado <strong
                                        class="text-danger">*</strong></label>


                                <select class="form-select" id="slestado" name="tipo_empleado">
                            ...
                            <div class="col-12 d-flex justify-content-center">
                                <button type="submit" class="btn btn-danger d-flex align-items-center mt-5">
                                    <div style="margin-right: 10%;">Guardar</div> <i
                                        class="fa-solid fa-floppy-disk fa-2x"></i>
                                </button>
                            </div>
                    </form>
                </div>
...
const municipiosPorEstado = {
    ...
    "CDMX": ["Alvaro Obregon", "Azcapotzalco", "Benito Juarez", "Coyoacan", "Cuajimalpa de Morelos",
    ...
    "Estado de México": ["Acambay de Ruiz Castaneda", "Acolman", "Aculco", "Almoloya de Alquisiras",
    ...
    "Michoacán": ["Acuitzio", "Aguililla", "Alvaro Obregon", "Angamacutiro", "Angangueo", "Apatzingan", "Aporo",
    ...
    "Nuevo León": ["Abasolo", "Agualeguas", "Allende", "Anahuac", "Apodaca", "Aramberri", "Bustamante",
    ...
    "Querétaro": ["Amealco de Bonfil", "Arroyo Seco", "Cadereyta de Montes", "Colon", "Corregidora", "El Marques",
    ...
    "Yucatán": ["Abala", "Acanceh", "Akil", "Baca", "Bokoba", "Buctzotz", "Cacalchen", "Calotmul", "Cansahcab",
