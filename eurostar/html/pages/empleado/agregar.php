        ...
        <div class="nav-align-top mb-4">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="navs-pills-persona-fisica" role="tabpanel">
                    <form method="post" action="?modulo=empleado&accion=empleadoadd">
                            ...
                            <div class="mb-3 col-md-3 col-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="txtpapellido"
                                        placeholder="Primer apellido" name="primer_apellido" aria-label="Primer apellido"
                                        aria-describedby="basic-icon-default-fullname2" require />
                                </div>
                            </div>
                            <div class="mb-3 col-md-3 col-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="txtsapellido"
                                        placeholder="Segundo apellido" name="segundo_apellido" aria-label="Segundo apellido"
                                        aria-describedby="basic-icon-default-fullname2" require />
                                </div>
                            </div>
                            <div class="mb-3 col-6 col-sm-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" id="txtcodigo" placeholder="Código"
                                        ...
                                        aria-describedby="basic-icon-default-fullname2" value="52" require />
                                </div>
                            </div>
                            <div class="mb-3 col-6 col-sm-3">
                            ...
                            <div class="mb-3 col-sm-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="txtrfc" placeholder="RFC" name="rfc"
                                        aria-label="RFC" aria-describedby="basic-icon-default-fullname2" require/>
                                </div>
                            </div>
                            <div class="mb-3 col-sm-6">
                        ...
                        <option value="venezuela">Venezuela</option>
                            ...
                            <div class="mb-3 col-6 col-md-6">
                                <label for="exampleFormControlSelect1" class="form-label">Estado <strong
                                        class="text-danger">*</strong></label>
                                <select onchange="cargarMunicipios()" class="form-select" id="slestado" aria-label="Default select example"
                            ...
                            <div class="mb-3 col-6 col-md-4">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="" class="input-group-text"><i class="bx bx-hash text-danger"></i></span>
                                    <input type="text" class="form-control" id="txtcolonia" placeholder="CTA NOMINA"
                                        name="cuenta_nomina" aria-label="Numero exterior"
                                        aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            <div class="mb-3 col-6 col-md-4">
