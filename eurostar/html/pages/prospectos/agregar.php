                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <select id="slcgirofisica" class="form-select" name="giro">
                            ...
                            <div class="mb-3 col-md-6">
                                <div id="divtipo">
                                    <label class="form-label" for="basic-icon-nombre-compañia">Tipo<strong
                                        ...
                                        <select type="text" class="form-control" id="slctipofisica" placeholder="Tipo"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-5 col-12 col-md-6">
                                <label for="exampleFormControlSelect1" class="form-label">País <strong
                                        class="text-primary">*</strong></label>
                                        <select class="form-select" name="pais" id="slpais">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <label for="exampleFormControlSelect1" class="form-label">Litros por mes<strong
                                            class="text-primary">*</strong></label>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group">
                                        <input type="file" class="form-control" id="inputGroupFile04"
                                            ...
                                            aria-label="Upload" accept="image/jpg, image/jpeg, image/png, image/gif">
                                        <span id="basic-icon-emailcomp" class="input-group-text"><i
                    ...
                    <form method="post" id="pmoral" action="?modulo=prospectos&accion=createpmoral">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="mb-3 col-12 col-md-6">
                                <label for="exampleFormControlSelect1" class="form-label">País <strong
                                        class="text-primary">*</strong></label>
                                    <select class="form-select" name="pais" id="slpaiscomp">
...
<script type="text/javascript">
    ...
    let girof = document.getElementById('slcgirofisica');
    let tipof = document.getElementById('slctipofisica');
