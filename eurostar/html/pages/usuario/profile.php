            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="text" class="form-control" id="txtnombre"
                                                placeholder="Nombre(s)" name="nombre" aria-label="Nombre(s)"
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="text" class="form-control" id="txtrfc"
                                                placeholder="RFC" name="rfc" aria-label="RFC"
                                                aria-describedby="basic-icon-default-fullname2" require
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                                    class="bx bx-card text-danger"></i></span>
                                            <input readonly type="text" class="form-control" id="txtcurp"
                                                placeholder="CURP" name="curp" aria-label="CURP"
                                                aria-describedby="basic-icon-default-fullname2" require
                                    ...
                                    <div class="mb-3 col-6 col-sm-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="text" class="form-control" id="txtcodigo"
                                    ...
                                    <div class="mb-3 col-6 col-sm-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                                    class="bx bx-phone-call text-danger"></i></span>
                                            <input readonly type="number" class="form-control" id="txtlada"
                                                placeholder="LADA" name="lada" aria-label="LADA"
                                                aria-describedby="basic-icon-default-fullname2" require
                                    ...
                                    <div class="mb-3 col-12 col-sm-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                                    class="bx bx-phone-call text-danger"></i></span>
                                            <input readonly type="number" class="form-control" id="txttel"
                                                placeholder="Número de teléfono" name="telefono"
                                                aria-label="Número de teléfono"
                                                aria-describedby="basic-icon-default-fullname2" require
                                                value="<?php echo (explode('|', $_SESSION['telefonos']))[3]; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="text" class="form-control" id="txtemail"
                                                placeholder="Correo eléctronico" name="email"
                                                aria-label="Número de teléfono"
                                                aria-describedby="basic-icon-default-fullname2" require
                                                value=" <?php echo'  '. (explode('|', $_SESSION['correos']))[1]; ?>" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="text" class="form-control" id="txtcalle"
                                                placeholder="Calle" name="calle" aria-label="Calle"
                                                aria-describedby="basic-icon-default-fullname2" require
                                    ...
                                    <div class="mb-3 col-6 col-md-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="number" class="form-control" id="txtnexterior"
                                    ...
                                    <div class="mb-3 col-6 col-md-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <span id="basic-icon-default-fulladdress2" class="input-group-text"><i
                                                    class="bx bx-hash text-danger"></i></span>
                                            <input readonly type="number" class="form-control" id="txtninterior"
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="text" class="form-control" id="txtcalles"
                                                placeholder="Entre calles" name="entreCalles" require
                                    ...
                                    <div class="mb-3 col-12 col-md-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <select disabled class="form-select" name="paises" id="paises">
                                                <option
                                                    value="<?php echo (explode('|', $_SESSION['direcciones']))[7]; ?>">
                                                    <?php echo (explode('|', $_SESSION['direcciones']))[7]; ?></option>
                                    ...
                                    <div class="mb-3 col-6 col-md-6">
                                        <label for="exampleFormControlSelect1" class="form-label">Estado <strong
                                                class="text-danger">*</strong></label>
                                        <select disabled onchange="cargarMunicipios()" class="form-select" id="slestado"
                                            aria-label="Default select example" name="estado" required>
                                            <option value="<?php echo (explode('|', $_SESSION['direcciones']))[6]; ?>"
                                                selected><?php echo (explode('|', $_SESSION['direcciones']))[6]; ?>
                                            </option>
                                    ...
                                    <div class="mb-3 col-6 col-md-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <select disabled class="form-select" name="municipio" id="txtmunicipio"
                                                id="txtmunicipio">
                                                <option
                                                    value="<?php echo (explode('|', $_SESSION['direcciones']))[5]; ?>">
                                                    <?php echo (explode('|', $_SESSION['direcciones']))[5]; ?></option>
                                            </select>
                                    ...
                                    <div class="mb-3 col-6 col-md-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <span id="" class="input-group-text"><i
                                                    class="bx bx-hash text-danger"></i></span>
                                            <input readonly type="text" class="form-control" id="txtcolonia"
                                                placeholder="Colonia" name="colonia" aria-label="Numero exterior"
                                                aria-describedby="basic-icon-default-fullname2"
                                                value="<?php echo (explode('|', $_SESSION['direcciones']))[3]; ?>" />
                                        </div>
                                    </div>
                                    <div class="mb-3 col-6 col-md-4">
                                        <label class="form-label" for="basic-icon-default-fullname">Código postal
                                            <strong class="text-danger">*</strong></label>
                                        <div class="input-group input-group-merge">
                                            <span id="basic-icon-default-fulladdress2" class="input-group-text"><i
                                                    class="bx bx-hash text-danger"></i></span>
                                            <input readonly type="number" class="form-control" id="txtcp"
                                                placeholder="CP" name="cp" aria-label="Numero exterior"
                                                aria-describedby="basic-icon-default-fullname2"
                        ...
                        <button type="button" id="editarbtn" class="btn btn-warning me-2"
                ...
                <div class="card-body">
                    <div class="mb-3 col-12 mb-0">
                        <div class="alert alert-warning">
                            ...
                            <p class="mb-0">Una vez que eliminas tu cuenta, no hay vuelta atrás. Por favor, esté seguro.
                            </p>
                        </div>
                    </div>
...
function activarEdicion() {
    ...
    Swal.fire({
        icon: 'warning',
        title: 'Modo edicion',
        text: 'Cambia los datos y para continuar de clic en "Guardar cambios": ',
        footer: ''
    })
    const select = document.getElementById('slestado');
    select.disabled = false;

    const select2 = document.getElementById('paises');
    select2.disabled = false;
    const select3 = document.getElementById('txtmunicipio');
    select3.disabled = false;

    const inputs = document.querySelectorAll('.form-control[readonly]');
    ...
    const boton2 = document.getElementById('sendchange');
...
const municipiosPorEstado = {
    ...
    "San Luis Potosi": ["Ahualulco", "Alaquines", "Aquismon", "Armadillo de los Infante", "Axtla de Terrazas",
