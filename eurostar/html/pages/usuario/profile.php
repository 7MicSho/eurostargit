                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" id="txtnombre" placeholder="Nombre(s)" name="nombre"
                        aria-label="Nombre(s)" aria-describedby="basic-icon-default-fullname2" require
                  ...
                  <div class="mb-3 col-md-3 col-6">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" id="txtpapellido" placeholder="Primer apellido"
                        name="primer_apellido" aria-label="Primer apellido"
                        aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo $_SESSION['primer_apellido']; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-md-3 col-6">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                      <input type="text" class="form-control" id="txtsapellido" placeholder="Segundo apellido"
                        name="segundo_apellido" aria-label="Segundo apellido"
                        aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo $_SESSION['segundo_apellido']; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-6 col-sm-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="number" class="form-control" id="txtcodigo" placeholder="Código" name="codigo"
                        aria-label="Código" aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo (explode('|', $_SESSION['telefonos']))[1]; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-6 col-sm-3">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"><i
                          class="bx bx-phone-call text-danger"></i></span>
                      <input type="number" class="form-control" id="txtlada" placeholder="LADA" name="lada"
                        aria-label="LADA" aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo (explode('|', $_SESSION['telefonos']))[2]; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-12 col-sm-6">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"><i
                          class="bx bx-phone-call text-danger"></i></span>
                      <input type="number" class="form-control" id="txttel" placeholder="Número de teléfono"
                        name="telefono" aria-label="Número de teléfono" aria-describedby="basic-icon-default-fullname2"
                        require value="<?php echo (explode('|', $_SESSION['telefonos']))[3]; ?>" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3 col-12">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" id="txtemail" placeholder="Correo eléctronico"
                        name="email" aria-label="Número de teléfono" aria-describedby="basic-icon-default-fullname2"
                        require value="<?php echo (explode('|', $_SESSION['correos']))[1]; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-sm-6">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"><i
                          class="bx bx-card text-danger"></i></span>
                      <input type="text" class="form-control" id="txtrfc" placeholder="RFC" name="rfc" aria-label="RFC"
                        aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo $_SESSION['rfc']; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-sm-6">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" id="txtcurp" placeholder="CURP" name="curp"
                        aria-label="CURP" aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo $_SESSION['curp']; ?>" />
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="mb-3 col-md-6">
                    <label class="form-label" for="basic-icon-default-fullname">Calle <strong
                        class="text-danger">*</strong></label>
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fulladdress2" class="input-group-text">
                        <i class="bx bx-buildings text-danger"></i>
                      </span>
                      <input type="text" class="form-control" id="txtcalle" placeholder="Calle" name="calle"
                        aria-label="Calle" aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo (explode('|', $_SESSION['direcciones']))[1]; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-6 col-md-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="number" class="form-control" id="txtnexterior" aria-label="Numero exterior"
                        name="nExt" aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo (explode('|', $_SESSION['direcciones']))[2]; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-6 col-md-3">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fulladdress2" class="input-group-text"><i
                          class="bx bx-hash text-danger"></i></span>
                      <input type="number" class="form-control" id="txtninterior" aria-label="Numero exterior"
                        name="nInt" aria-describedby="basic-icon-default-fullname2" require
                        value="<?php echo (explode('|', $_SESSION['direcciones']))[9]; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-12">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" id="txtcalles" placeholder="Entre calles"
                        name="entreCalles" require
                        value="<?php echo (explode('|', $_SESSION['direcciones']))[4]; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-12 col-md-6">
                    <label for="exampleFormControlSelect1" class="form-label">País <strong
                        ...
                        <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fulladdress2" class="input-group-text">
                                      <i class="bx bx-world text-danger"></i>
                                    </span>
                    <select class="form-select" name="paises">
                      <option value="<?php echo (explode('|', $_SESSION['direcciones']))[7]; ?>"><?php echo (explode('|', $_SESSION['direcciones']))[7]; ?></option>
                  ...
                  <div class="mb-3 col-6 col-md-6">
                    <label for="exampleFormControlSelect1" class="form-label">Estado <strong
                        class="text-danger">*</strong></label>
                    <select onchange="cargarMunicipios()" class="form-select" id="slestado"
                      aria-label="Default select example" name="estado" required>
                      <option value="<?php echo (explode('|', $_SESSION['direcciones']))[6]; ?>" selected><?php echo (explode('|', $_SESSION['direcciones']))[6]; ?></option>
                  ...
                  <div class="mb-3 col-6 col-md-4">
                    <label class="form-label" for="basic-icon-default-fullname">Municipio <strong
                        class="text-danger">*</strong></label>
                    <div class="input-group input-group-merge">
                      <span id="" class="input-group-text"><i class="bx bx-hash text-danger"></i></span>

                      <select class="form-select" name="municipio" id="txtmunicipio">
                        <option value="<?php echo (explode('|', $_SESSION['direcciones']))[5]; ?>"><?php echo (explode('|', $_SESSION['direcciones']))[5]; ?></option>
                      </select>
                  ...
                  <div class="mb-3 col-6 col-md-4">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="" class="input-group-text"><i class="bx bx-hash text-danger"></i></span>
                      <input type="text" class="form-control" id="txtcolonia" placeholder="Colonia" name="colonia"
                        aria-label="Numero exterior" aria-describedby="basic-icon-default-fullname2"
                        value="<?php echo (explode('|', $_SESSION['direcciones']))[3]; ?>" />
                    </div>
                  </div>
                  <div class="mb-3 col-6 col-md-4">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fulladdress2" class="input-group-text"><i
                          class="bx bx-hash text-danger"></i></span>
                      <input type="number" class="form-control" id="txtcp" placeholder="CP" name="cp"
                        aria-label="Numero exterior" aria-describedby="basic-icon-default-fullname2"
                        value="<?php echo (explode('|', $_SESSION['direcciones']))[8]; ?>" />
                    </div>
                  </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form id="formAccountDeactivation" onsubmit="return false">
              ...
              <button type="submit" class="btn btn-danger deactivate-account">Deaactivar Cuenta</button>
            </form>
          </div>
        </div>
      </div>
