                ...
                <div class="authentication-inner">
                    ...
                    <div class="card" style="background: rgba(0, 0, 0, .0); -webkit-box-shadow: 0px 0px 30px 5px rgba(0,0,0,0.30); 
                        ...
                        <div class="card-body">
                            ...
                            <!-- /Logo -->
                            <h3 class="mb-2 text-center" style="color: white;">Bienvenido</h4>
                                <p class="mb-4 text-center">Ingresa tu usuario y contraseña</p>

                                <form id="formAuthentication" class="mb-3" action="?modulo=usuario&accion=entrar" method="post">
                                    <div class="mb-3" style="color: white;">
                                        <input type="text" class="form-control bg-dark" name="username" placeholder="Usuario" style="color: white;" autofocus autocomplete="off" required />
                                    </div>
                                    <div class="mb-3 form-password-toggle">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" class="form-control bg-dark" name="password" style="color: white;" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" autocomplete="off" required />
                                ...
                                <?php if (isset($_GET['faillogin'])) { ?>
                                    <p style="text-align: center;color:red;" id="faillogintxt">
                                        <small>USUARIO Y/O CONTRASEÑA INCORRECTO</small>
                                    </p>
                                <?php } ?>
...
<script>
    <?php if (isset($_GET['faillogin'])) { ?>
           setInterval(a,3000);
           function a(){
            document.getElementById('faillogintxt').innerHTML="";
           }
    <?php } ?>
</script>